  ...
  <div class="w-full h-screen bg-orange-50 flex items-center">
    <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
      <div class="max-w-md">
        ...
        <button
          class="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white bg-primary rounded-lg hover:(shadow-lg shadow-primary/50 transition transform scale-105) active:opacity-70"
          @click="$nuxt.$router.replace('/')"
        >
          返回首页
        </button>
      </div>
